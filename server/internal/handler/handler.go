...
type Handler struct {
	...
	// OpenContent is a fixed-route facade used by the oc-basic skill. The
	// caller's OpenContent API key is carried in Authorization and is never
	// persisted by Multica.
	OpenContent                 *opencontent.Client
