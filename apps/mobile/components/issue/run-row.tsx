...
const FAILURE_REASON_LABEL: Record<string, string> = {
  ...
  "agent_error.provider_server_error": "服务提供方错误",
  ...
  "agent_error.runtime_version_unsupported": "命令行版本不受支持",
  "agent_error.runtime_missing_executable": "命令行工具未安装",
