 ...
 * `Issues | 鸿翼灵工` and `Changelog | 鸿翼灵工` can never drift into two
...
export const SITE_TITLE = "鸿翼灵工 — Project Management for Human + Agent Teams";

/** Appended to every page-specific title. */
export const TITLE_SUFFIX = " | 鸿翼灵工";
