...
export const metadata: Metadata = {
  title: "Download 鸿翼灵工",
  description:
    "Download 鸿翼灵工 for macOS, Windows, or Linux — or install the CLI for servers and remote dev boxes.",
  openGraph: {
    title: "Download 鸿翼灵工",
    description:
      "Get the 鸿翼灵工 desktop app with a bundled daemon, or install the CLI for servers and remote dev boxes.",
    url: "/download",
  },
  alternates: {
    canonical: "/download",
