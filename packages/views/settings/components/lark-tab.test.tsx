...
// row uses it to render the 鸿翼灵工 agent's name in place of the raw
...
// renders the 鸿翼灵工 agent's avatar + name (joined via inst.agent_id),
...
describe("LarkTab connected bots list (agent identity rendering)", () => {
  ...
  it("renders the 鸿翼灵工 agent's name and avatar instead of the raw Lark app_id / bot_open_id", () => {
